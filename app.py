...
def applications(id=None):
    ...
    if id is not None:
        j = api(f"https://store.nashstore.ru/api/mobile/v1/categories/application/{id}")
        page = {
...
def get_application():
    try:
        ...
        return "Not a valid download URL"
...
def server_error(e):
    return (
        render_template("error.html", code="500", description="Internal Server Error"),
        500,
    )
